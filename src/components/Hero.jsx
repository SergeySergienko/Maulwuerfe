...
const Hero = ({
  ...
  return isFullHero ? (
    ...
    >
      ...
      <div className='z-10 flex flex-col justify-between w-full h-full pt-20 pb-12 external-container'>
        <motion.div
        ...
        >
          ...
          <p className='hidden md:block mb-4 text-sm text-white brightness-75'>
            Treten Sie ein in die Welt des Freiberger Maulwürfe Teams! Machen
            Sie sich bereit, den Teamgeist zu spüren und unsere großartigen
